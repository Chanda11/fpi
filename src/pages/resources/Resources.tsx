            ...
            <div className="bg-[#080c1a] rounded-2xl overflow-hidden shadow-2xl grid lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 text-white flex flex-col justify-center">
                ...
                <div className="flex flex-wrap gap-3">
                  {resourcesData.featured.buttons.map((btn, i) => (
                    <a
                      key={i}
                      href={btn.link}
                      className={`px-6 py-2 rounded-full text-sm font-semibold transition hover:-translate-y-1 ${
                        i === 0
                          ? "bg-gradient-to-r from-[#C9293A] to-[#E8610A] text-white shadow-lg"
