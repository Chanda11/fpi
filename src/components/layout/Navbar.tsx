  ...
  const navItems = {
    ...
    programs: {
      ...
      items: [
        ...
        { name: "SheRise", path: "/projects/sherise", description: "Empowering women and girls" },
        { name: "Claim Your Space", path: "/projects/claim-your-space", description: "Promoting civic participation" },
        { name: "Funsani", path: "/projects/funsani", description: "Community empowerment initiative" },
